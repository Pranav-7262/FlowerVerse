...
const Footer = () => {
  ...
  const info = [
    ...
    { icon: Mail, text: "hello@flowerverse.com", label: "Email" },
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-black text-rose-700">FlowerVerse</h2>
            </div>
        ...
        >
          ...
          <div className="flex items-center gap-2 text-xs text-slate-600">
            ...
            <span>by FlowerVerse</span>
          </div>

          {/* Right */}
          <p className="text-xs text-slate-600 text-center md:text-right">
            © {currentYear} FlowerVerse. All rights reserved.
          </p>
        </motion.div>
      </div>
